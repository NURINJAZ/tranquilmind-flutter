...
class _AppointmentPageState extends State<AppointmentPage> {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              CircleAvatar(
                                backgroundImage: NetworkImage(
                                    "http://tranquilmind.icu${schedule['doctor_profile']}"),
                              ),
                              const SizedBox(
                                width: 10,
                              ),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: _buildButtons(schedule),
                          ),
                        ],
                      ),
                    ),
  ...
  List<Widget> _buildButtons(Map<String, dynamic> schedule) {
    List<Widget> buttons = [];
      ...
      buttons.add(
        Expanded(
          child: OutlinedButton(
            onPressed: () async {
              var appointmentId =
                  schedule['id']; // Assuming 'id' is the appointment ID
              ...
              if (response == 200) {
                // Update UI or show a message indicating successful cancellation
          ...
          child: OutlinedButton(
            ...
            onPressed: () {
              Navigator.of(context).pushNamed(
                'reschedule_booking_page',
                arguments: {
                  "doctor": schedule['doctor'],
                  "currentAppointment": schedule,
                },
              );
            },
            child: const Text(
    ...
    } else if (schedule['status'] == FilterStatus.complete) {
      buttons.add(
        Expanded(
          child: OutlinedButton(
            onPressed: () async {
    ...
    } else if (schedule['status'] == FilterStatus.cancel) {
      buttons.add(
        Expanded(
          child: OutlinedButton(
            style: OutlinedButton.styleFrom(
